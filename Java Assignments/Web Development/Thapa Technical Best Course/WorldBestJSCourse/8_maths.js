...
/* 
How to generate an random no. b/w certain range ?

1. num = Math.random() * (max - min + 1) + min.

2. Math.floor(num).
where (max - min + 1) => Total distinct no. 

Example : Generate random number between 75 to 84

        Total distinct no. => (84 - 75 + 1) => 10

        Math.random() * 10 + 75

        So, this way the random number is generated between 75 to 84.
*/
